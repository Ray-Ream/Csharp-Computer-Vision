namespace DIP_3D
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1 = new Label();
            label2 = new Label();
            visualize_templateImage = new PictureBox();
            loadTemplate_btn = new Button();
            cosineSimilarity_btn = new Button();
            SAD_btn = new Button();
            ...
            ((System.ComponentModel.ISupportInitialize)visualize_templateImage).BeginInit();
            SuspendLayout();
            // 
            // visualize_leftImage
            // 
            ...
            visualize_RightImage.Location = new Point(568, 12);
            ...
            // loadRightImage_btn
            // 
            loadRightImage_btn.Location = new Point(568, 418);
            ...
            img02_label.Location = new Point(686, 421);
            ...
            // 
            calculationResults_btn.Location = new Point(568, 457);
            ...
            calculationResults_label.Location = new Point(707, 460);
            ...
            label2.Text = "右圖座標：";
            // 
            // visualize_templateImage
            // 
            visualize_templateImage.BackColor = SystemColors.ControlDark;
            visualize_templateImage.Location = new Point(1124, 12);
            visualize_templateImage.Name = "visualize_templateImage";
            visualize_templateImage.Size = new Size(330, 244);
            visualize_templateImage.TabIndex = 16;
            visualize_templateImage.TabStop = false;
            // 
            // loadTemplate_btn
            // 
            loadTemplate_btn.Location = new Point(1124, 262);
            loadTemplate_btn.Name = "loadTemplate_btn";
            loadTemplate_btn.Size = new Size(144, 23);
            loadTemplate_btn.TabIndex = 17;
            loadTemplate_btn.Text = "Load template image";
            loadTemplate_btn.UseVisualStyleBackColor = true;
            loadTemplate_btn.Click += loadTemplate_btn_Click;
            // 
            // cosineSimilarity_btn
            // 
            cosineSimilarity_btn.Location = new Point(1124, 291);
            cosineSimilarity_btn.Name = "cosineSimilarity_btn";
            cosineSimilarity_btn.Size = new Size(144, 23);
            cosineSimilarity_btn.TabIndex = 18;
            cosineSimilarity_btn.Text = "Cosine Similarity";
            cosineSimilarity_btn.UseVisualStyleBackColor = true;
            cosineSimilarity_btn.Click += cosineSimilarity_btn_Click;
            // 
            // SAD_btn
            // 
            SAD_btn.Location = new Point(1124, 320);
            SAD_btn.Name = "SAD_btn";
            SAD_btn.Size = new Size(186, 23);
            SAD_btn.TabIndex = 19;
            SAD_btn.Text = "Sum of absolute differences";
            SAD_btn.UseVisualStyleBackColor = true;
            SAD_btn.Click += SAD_btn_Click;
            // 
            // similarityLabel
            // 
            similarityLabel.AutoSize = true;
            similarityLabel.Font = new Font("Microsoft JhengHei UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
            similarityLabel.Location = new Point(1274, 262);
            similarityLabel.Name = "similarityLabel";
            similarityLabel.Size = new Size(116, 20);
            similarityLabel.TabIndex = 21;
            similarityLabel.Text = "similarityLabel";
            // 
            // Form1
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(1466, 566);
            Controls.Add(similarityLabel);
            Controls.Add(SAD_btn);
            Controls.Add(cosineSimilarity_btn);
            Controls.Add(loadTemplate_btn);
            Controls.Add(visualize_templateImage);
            Controls.Add(label2);
            Controls.Add(label1);
            ...
            ((System.ComponentModel.ISupportInitialize)visualize_templateImage).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private PictureBox visualize_templateImage;
        private Button loadTemplate_btn;
        private Button cosineSimilarity_btn;
        private Button SAD_btn;
